...
def generate(
    ...
    # Clean the JSON data to fix note parsing issues
    try:
        ...
        for note in parsed_data:
            ...
            cleaned_data.append(cleaned_note)
        json_data = json.dumps(cleaned_data)
    except Exception as e:
        console.print(f"[bold yellow]Warning: Could not clean note data: {e}[/bold yellow]")
